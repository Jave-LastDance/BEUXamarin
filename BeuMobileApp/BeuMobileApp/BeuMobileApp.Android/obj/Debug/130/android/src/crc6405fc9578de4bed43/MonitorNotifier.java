...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BeuMobileApp.Droid.MonitorNotifier, BeuMobileApp.Android", MonitorNotifier.class, __md_methods);
	}
	...
	public MonitorNotifier ()
	{
		...
		if (getClass () == MonitorNotifier.class) {
			mono.android.TypeManager.Activate ("BeuMobileApp.Droid.MonitorNotifier, BeuMobileApp.Android", "", this, new java.lang.Object[] {  });
		}
	}
